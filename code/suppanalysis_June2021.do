...
eststo clear
local product "all big4other big4 maize rice wheat soybean"
foreach prod in `product'{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress `prod' trend
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
}
esttab using results_tableS5.rtf, b(2) ///
		se(2) ar2(3) stats(r2_a DF_GLS pTau pPval, fmt(2)) star(* 0.10 ** 0.05 *** 0.01) replace  
...
foreach prod in `product'{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress `prod' trend trend2
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
}
esttab using results_tableS5.rtf, b(2) ///
		se(2) ar2(3) stats(r2_a DF_GLS pTau pPval, fmt(2)) star(* 0.10 ** 0.05 *** 0.01)  append	
...
foreach prod in `product'{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress `prod' trend_before trend_after
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
}
...
foreach reg in `region'{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress `reg' trend
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
}
	esttab using results_tableS6.rtf, b(2) ///
		se(2) ar2(3) stats(r2_a DF_GLS pTau pPval, fmt(2)) star(* 0.10 ** 0.05 *** 0.01)  replace	
...
foreach reg in `region'{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress `reg' trend trend2
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
}
...
foreach reg in `region'{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress `reg' trend_before trend_after
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
}	
...
forv i=1/4{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress cyield`i' trend
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
	local i=`i'+1
}
	esttab using results_tableS7.rtf, b(2) ///
		se(2) ar2(3) stats(r2_a DF_GLS pTau pPval, fmt(2)) star(* 0.10 ** 0.05 *** 0.01)  replace	
...
forv i = 1/4{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress cyield`i' trend trend2
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
}
...
forv i=1/4{
	...
	local pT=r(Zt)
	local pP=r(pval)
	eststo: quietly regress cyield`i' trend_before trend_after
	estadd scalar DF_GLS = b[`k',5]
	estadd scalar pTau = `pT'
	estadd scalar pPval = `pP'
}	
